...
def cargar_prompt(nombre_archivo: str) -> str:
    return (PROMPTS_DIR / nombre_archivo).read_text(encoding="utf-8")


EMPRESA = cargar_prompt("empresa.md")
CATALOGO = cargar_prompt("catalogo.md")
INSTRUCCIONES = cargar_prompt("instrucciones.md")
...
prompt_template = PromptTemplate(
    input_variables=["mensaje", "historial", "empresa", "catalogo", "instrucciones"],
    template="""# Contexto de la empresa
{empresa}
